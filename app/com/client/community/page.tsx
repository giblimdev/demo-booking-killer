...
import { 
  Eye, Shield, Gift, User, Check, BarChart, 
  ArrowRight, Zap, Users, Star, AlertCircle 
} from 'lucide-react';
  ...
  const processSteps = [
    {
      ...
      description: "Lors de vos recherches, repérez une différence de prix suspecte entre une plateforme et le prix direct",
      icon: <Eye size={36} className="text-amber-500" />
    },
    {
      step: 2,
      title: "Signalez via l'application",
      description: "Capturez l'écran et envoyez le détail de l'offre en quelques secondes",
      icon: <AlertCircle size={36} className="text-red-500" />
    },
    {
      step: 3,
      title: "Validation par l'hôtelier",
      description: "L'hôtelier confirme la commission réelle dans son backoffice",
      icon: <Check size={36} className="text-green-500" />
    },
    {
      step: 4,
      title: "Crédits voyage offerts",
      description: "Recevez des crédits utilisables sur vos prochaines réservations",
  ...
  const benefits = [
    {
      ...
      description: "Chaque signalement protège des milliers de voyageurs potentiels"
    },
    {
      icon: <BarChart size={32} className="text-green-500" />,
      title: "Transparence totale",
      description: "Les données validées sont partagées pour éclairer toute la communauté"
    },
    {
  ...
  const testimonials = [
    {
      ...
      text: "En 3 signalements, j'ai gagné 45€ de crédits voyage. Mais surtout, j'ai aidé plusieurs hôteliers à révéler des commissions abusives!",
      credits: 45
    },
    {
      name: "Hôtel du Parc",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white font-sans">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-indigo-900 py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-yellow-400">LA COMMUNAUTÉ QUI RÉVOLUTIONNE LE VOYAGE</span>
          </motion.h1>
          ...
          >
            <div className="inline-flex items-center bg-black bg-opacity-30 px-6 py-3 rounded-full mb-8">
              ...
              <span className="font-bold text-xl">Votre super-pouvoir : garantir des prix justes pour tous</span>
            </div>
            
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
              Rejoignez notre armée de veilleurs et transformez chaque signalement en crédits voyage
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Un système simple et récompensé pour garantir la transparence des prix
            </p>
          </motion.div>
            ...
            {processSteps.map((step) => (
              <motion.div 
                ...
                className={`bg-gradient-to-br from-gray-800 to-gray-900 border rounded-xl p-6 text-center ${
                  activeStep === step.step ? 'border-yellow-500' : 'border-gray-700'
                }`}
              ...
              <div className="flex-1">
                ...
                {activeStep === 1 && (
                  <div className="flex items-center bg-black bg-opacity-30 p-3 rounded-lg">
                    ...
                    <span>Exemple: Une chambre à 120€ sur Booking, mais 85€ en direct</span>
                  </div>
                )}
                ...
                {activeStep === 2 && (
                  <div className="flex items-center bg-black bg-opacity-30 p-3 rounded-lg">
                    ...
                    <span>Notre système analyse automatiquement la différence</span>
                  </div>
                )}
                ...
                {activeStep === 3 && (
                  <div className="flex items-center bg-black bg-opacity-30 p-3 rounded-lg">
                    ...
                    <span>"Oui, Booking prend 35% sur ce prix" - Hôtel du Parc</span>
                  </div>
                )}
      ...
      <div className="py-16 px-4 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Plus qu'un système de récompense, un mouvement pour changer l'industrie
            </p>
          </motion.div>
                ...
                <div className="border-t border-gray-700 pt-4 flex justify-between items-center">
                  ...
                  {testimonial.credits && (
                    <div className="flex items-center bg-yellow-500 text-gray-900 px-3 py-1 rounded-full">
                      ...
                      <span className="font-bold">{testimonial.credits}€</span>
                    </div>
                  )}
                </div>
              </motion.div>
          ...
          <div className="bg-gradient-to-r from-blue-800 to-indigo-900 rounded-xl p-6 border border-yellow-500">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p>
                  Chaque signalement validé est transformé en alerte publique pour protéger l'ensemble des voyageurs.
                  Les hôteliers peuvent corriger leurs prix en direct grâce à ces informations.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="py-20 px-4 bg-gradient-to-r from-yellow-600 to-yellow-800 text-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">PRÊT À DEVENIR UN SUPER-HÉROS DU VOYAGE ?</h2>
            <p className="text-xl mb-10 max-w-2xl mx-auto">
              Rejoignez la communauté des veilleurs et transformez chaque voyage en mission
            </p>
      ...
      <footer className="py-8 px-4 bg-black text-center border-t border-yellow-500">
        <p className="text-lg">DIRECT HORIZON - La puissance de la communauté contre les commissions abusives</p>
        <p className="text-sm mt-2">Ensemble, nous rendons le voyage plus juste et transparent</p>
      </footer>
    </div>
  );
}