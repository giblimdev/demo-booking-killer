...
export default function BookingLinks() {
  ...
  const links = [
    { name: 'Booking Better', url: 'https://www.booking-better.com/', category: 'Alternative' },
    ...
    { name: 'Trivago', url: 'https://www.trivago.fr/', category: 'Comparateur' },
    { name: 'Lastminute', url: 'https://www.fr.lastminute.com/', category: 'Dernière Minute' },
    { name: 'Skyscanner', url: 'https://www.skyscanner.fr/hotels', category: 'Comparateur' },
    { name: 'Kayak', url: 'https://www.kayak.fr/hotels', category: 'Comparateur' },
    { name: 'Stayforlong', url: 'https://www.stayforlong.fr/', category: 'Alternative' },
    { name: 'Logitravel', url: 'https://www.logitravel.fr/hotels/', category: 'Voyage' },
    { name: 'eDreams', url: 'https://www.edreams.fr/hotels/', category: 'Voyage' },
    { name: 'Staycation', url: 'https://www.staycation.co/fr', category: 'Alternative' },
    { name: 'Agoda', url: 'https://www.agoda.com/fr-fr/?cid=1844104&ds=qQTyMBy2A4RRyNam', category: 'Géant' },
    { name: 'Orbitz', url: 'https://www.orbitz.com/', category: 'Géant' },
    { name: 'Travelocity', url: 'https://www.travelocity.com/', category: 'Géant' },
    { name: 'Priceline', url: 'https://www.priceline.com/', category: 'Géant' },
    { name: 'Hotwire', url: 'https://www.hotwire.com/', category: 'Dernière Minute' },
    { name: 'Google Hotels', url: 'https://www.google.com/travel/hotels', category: 'Comparateur' },
  ];
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-6 border-b border-red-600">
          <div>
            ...
            <p className="text-gray-400 mt-2">Connais ton ennemi - Les plateformes de réservation</p>
          </div>
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
          >
            {isSearching ? <FiX className="mr-2" /> : <FiSearch className="mr-2" />}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="bg-gray-800 border border-red-600 rounded-lg p-4">
            <div className="text-3xl font-bold text-red-500">{links.length}</div>
            <div className="text-gray-400">Plateformes répertoriées</div>
          </div>
          <div className="bg-gray-800 border border-red-600 rounded-lg p-4">
            <div className="text-3xl font-bold text-red-500">{categories.length}</div>
                ...
                <div className="mt-6 flex justify-between">
                  <div className="text-sm text-gray-400">
                    ...
                    <span className="ml-1 text-red-400 font-bold">
                      {link.category === 'Géant' ? '15-30%' : 
                       link.category === 'Comparateur' ? '10-20%' : 
                       link.category === 'Alternative' ? '5-15%' : '10-25%'}
                    </span>
                  </div>
                  
                  <div className={`px-2 py-1 text-xs rounded-full ${
                    link.category === 'Géant' ? 'bg-red-900 text-red-300' : 
                    link.category === 'Alternative' ? 'bg-green-900 text-green-300' : 'bg-blue-900 text-blue-300'
                  }`}>
                    {link.category === 'Géant' ? 'Éviter' : 
                     link.category === 'Alternative' ? 'Alternative' : 'Comparer'}
                  </div>
                </div>
              </div>
            </motion.a>
        ...
        <div className="mt-12 p-6 bg-gradient-to-r from-red-900 to-red-800 rounded-xl border border-red-600">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2">Attention aux commissions cachées !</h3>
              <p>
                Les plateformes traditionnelles prennent jusqu'à 30% de commission sur chaque réservation.
                Chez Direct Horizon, nous proposons une alternative avec <span className="font-bold text-green-400">0% de commission</span> 
        ...
        <footer className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
          ...
          <p className="mt-2">Données mises à jour: {new Date().toLocaleDateString('fr-FR')}</p>
        </footer>
      </motion.div>
    </div>
  );
